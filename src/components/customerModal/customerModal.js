...
import { Box, Typography, Button, TextField, Grid, MenuItem, Select, InputLabel, FormControl, Table, TableBody, TableRow, TableCell } from '@mui/material';
...
const CustomerModal = ({ customer, onClose, onEdit }) => {
